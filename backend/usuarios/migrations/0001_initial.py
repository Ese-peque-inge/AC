    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_curso', models.CharField(choices=[('Activo', 'Activo'), ('Finalizado', 'Finalizado'), ('Cancelado', 'Cancelado')], default='Activo', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('Administrador', 'Administrador'), ('Instructor', 'Instructor'), ('Alumno', 'Alumno')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_inscripcion', models.CharField(default='Activa', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inscripcion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='detalles', to='usuarios.inscripcion')),
            ],
        ),
        migrations.CreateModel(
            name='Instructor',
        ...
        migrations.AddField(
            ...
            name='instructor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuarios.instructor'),
        ),
        migrations.CreateModel(
